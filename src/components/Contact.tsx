...
const Contact = () => {
  return (
    <section className="relative bg-white md:h-[80vh]">
      <div className="overflow-hidden">
        <iframe
          className="z-0 mt-[-15vh] h-[110vh] w-full md:absolute"
          title="GoogleMap"
      ...
      <div className="md:container xl:mx-auto">
        <div className="left-0 z-10 flex h-full flex-col gap-y-8 bg-white px-6 pt-8 sm:px-10 md:absolute md:shadow-2xl">
          <h2 className="mt-12 text-3xl font-bold tracking-wider text-secondary">
            お問い合わせ
          </h2>
          ...
          <div className="mt-8 text-left">
            ...
            <p className="mt-2 text-xs tracking-widest text-secondary">
              2階へ上がって右の奥にあります
            </p>
          </div>
          <a
